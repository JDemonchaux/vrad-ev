    ...
    <header class="navbar navbar-static-top bs-docs-nav navbar-default navbar-inverse"  id="top" role="banner">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
                ...
                <?php 
                if (!empty($CI->config->item("entreprise_logo"))) {
                    ?>
                    <a class="navbar-brand logo" href="#">
                    <?php echo img_url($CI->config->item("entreprise_logo"),"Logo","logo"); ?>
                   </a>
                    <?php
                }else{
                  ?><a class="navbar-brand" href="#"><?php echo $CI->config->item("entreprise_name");?></a><?php
                }
                ?> 
        </div>
