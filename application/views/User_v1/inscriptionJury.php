                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" aria-describedby="input-group-specialite">
                                            <option>PHP</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" aria-describedby="input-group-represente" id="represente">
                                            <option>Ecole de test</option>
                                        </select>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer hcenter">
                    ...
                    <button class="btn btn-primary" type="submit" onclick="return false;">Enregistrer l'&eacute;cole</button>&nbsp;
                </div>
            </div>
        </div>
