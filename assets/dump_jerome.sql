...
(9, 3, 2, 3, 'membre', 'user', 'user', 'user@gmail.com', '93046758d21048ae10e9fa249537aa79', 1),
(10, NULL, 1, NULL, 'jury', 'jury', 'jury', 'jury@gmail.com', '93046758d21048ae10e9fa249537aa79', 1),
(11, 4, 2, 3, 'membre', 'Demonchaux', 'Jerome', 'jerome.demonchaux@gmail.com', '08adfb6ad85c3a66b42f69139f3cec80', 1);
...
--
ALTER TABLE `tm_group_grp`
  MODIFY `pk_grp` int(2) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `tm_user_usr`
  MODIFY `pk_usr` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
